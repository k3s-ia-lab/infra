...
- [zabbix](zabbix/README.md) + [grafana](grafana/README.md), to monitor the gpu burning.
- [keycloak](keycloak/README.md), to test some identity management stuff.
- [kubeshark](kubeshark/README.md),  to inspect k3s network traffic, and see how llm is talking to mcp server.
